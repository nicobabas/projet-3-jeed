...
const url = 'http://localhost:8000/fabrications/';

const CreateFabrication = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (name) {
      const newFabrication = { name: name };
      axios.post(url, newFabrication).then(({ data }) => {
  ...
  return (
    <div className="createfabrication">
      <div>
                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                    <h2 className="mb-5 text-lg font-medium leading-6 text-gray-900">
                      Créer ou supprimer un lieu de fabrication
                    </h2>
                    <label
                      htmlFor="name"
...
export default CreateFabrication;
